...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Future<void> _save() async {
    ...
    if (mounted) {
      ...
      PetTrackApp.setLocale(context, Locale(_languageCode));
      ...
      PetTrackApp.setThemeMode(context, newMode);
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<String>(
                      ...
                      items: const [
                        ...
                        DropdownMenuItem(
                          value: 'it',
                          child: Text('Italiano (AI-GENERATED)'),
                        ),
                        DropdownMenuItem(
                          value: 'de',
                          child: Text('Deutsch (AI-GENERATED)'),
                        ),
                        DropdownMenuItem(
                          value: 'ja',
                          child: Text('日本語 (AI-GENERATED)'),
                        ),
                        DropdownMenuItem(
                          value: 'ko',
                          child: Text('한국어 (AI-GENERATED)'),
                        ),
                      ],
  ...
  Widget _buildAlertsCard(AppLocalizations l10n) {
    return _buildCard(l10n.alertsTitle, [
      SwitchListTile(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              _buildProfilePicture(l10n),
                              const SizedBox(height: 32),
                              _buildProfileCard(l10n),
                              _buildAlertsCard(l10n),
                            ],
                          ),
                        ),
